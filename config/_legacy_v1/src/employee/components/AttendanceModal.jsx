...
export default function AttendanceModal({ isOpen, onClose, onSuccess, onFailure }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // CRITICAL: Rollback UI if backend fails
            if (onFailure) onFailure(err.message || 'Failed to submit attendance')
        }
    }
