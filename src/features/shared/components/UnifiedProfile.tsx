                    ...
                    <div className="flex gap-2">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                disabled={!isEditing}
                                className="w-full pl-9 pr-4 py-2 bg-slate-50 rounded-xl border-transparent focus:bg-white focus:border-indigo-500 focus:ring-0 transition-all font-medium disabled:opacity-75"
                                placeholder="+91..."
                            />
                        </div>
                        {isEditing ? (
