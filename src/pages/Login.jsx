    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            ...
            if (!userSnapshot.exists()) {
                ...
                logger.info('🔍 Checking for pre-added employee record by phone...')
                ...
                if (phoneSnapshot.exists()) {
                    ...
                    logger.info('♻️ Found pre-added record. Migrating to real UID...', oldUid)
                    ...
                    logger.info('✅ Migration complete. Login successful.')
